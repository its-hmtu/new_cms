const PATH = {
  ...
  MONITOR: {
    ...
    SMSC_MTTPS: '/monitor/smsc/mt-tps',
    SMSC_MOTPS: '/monitor/smsc/mo-tps',
  ...
  MANAGEMENT: {
    ...
    CLIENT_TPS_BY_TIME: '/management/client/tps-by-time-management',
    CLIENT_DELIVERY_REPORT_ACCOUNT: '/management/client/delivery-report-account',
  },
  HISTORY_REPORT: {
    ROOT: '/history-and-report',
    SMS_HISTORY: '/history-and-report/sms-history',
    MT_TRAFFIC: '/history-and-report/mt-traffic',
    MT_TRAFFIC_CLIENT: '/history-and-report/mt-traffic/client',
    MT_TRAFFIC_SMSC: '/history-and-report/mt-traffic/smsc',
    MO_TRAFFIC: '/history-and-report/mo-traffic',
    MO_TRAFFIC_CLIENT: '/history-and-report/mo-traffic/client',
    MO_TRAFFIC_SMSC: '/history-and-report/mo-traffic/smsc',
  },
  ADMINISTRATION: {
    ROOT: '/administration',
